...
Revision ID: 622d6d2784b9
Revises: 
Create Date: 2025-04-07 00:39:20.862900
...
def upgrade() -> None:
    ...
    op.create_table('user_leitner_settings',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    sa.ForeignKeyConstraint(['user_id'], ['users.user_id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('user_id', 'course_id', 'section_id', name='uix_user_course_section')
    )
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('user_leitner_settings')
